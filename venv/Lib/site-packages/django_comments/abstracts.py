...
class CommentAbstractModel(BaseCommentAbstractModel):
    ...
    user_email = models.EmailField(_("user's email address"), blank=True, null=True, default='xxx@xxx.com')
    user_url = models.URLField(_("user's URL"), blank=True, null=True, default='http://xxx.xxx.com')


    user_name = models.CharField(_("user's name"), max_length=128, blank=True)
    user_img = models.ImageField(upload_to='user_images', null=True, blank=True, verbose_name='user image')
    comment_title = models.CharField(max_length=256, default='无标题')
